    ...
    return (
        <div className="d-flex flex-column vh-100">
            ...
            <Navbar bg="dark" variant="dark" expand="lg" className="flex-shrink-0">
                <Container fluid>
                    <Navbar.Brand as={Link} to="/admin">Admin Portal</Navbar.Brand>
                ...
                >
                    <nav className="p-3 d-flex flex-column flex-grow-1">
                        ...
                        <div className="flex-grow-1">
                            ...
                            <NavLink to="/admin/hr" style={navLinkStyle}>👥 Manage HR</NavLink>
                            <NavLink to="/admin/candidates" style={navLinkStyle}>🧑‍💼 Manage Candidates</NavLink>
                            <NavLink to="/admin/applications" style={navLinkStyle}>📋 Manage Applications</NavLink>
                        </div>
